    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600 mt-2">Your AI-Powered Placement Preparation Partner</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white py-3 rounded-lg font-medium hover:from-blue-600 hover:to-purple-700 transition-all flex items-center justify-center gap-2"
            >
              {isSignUp ? (
                <>
                  <UserPlus size={20} />
        ...
        <div className="mt-4 text-center">
          <button
            onClick={() => {
              // Set demo profile and skip to dashboard
          ...
          >
            Quick Demo Access (Skip to Dashboard)
          </button>
        </div>
      </div>
    </div>
